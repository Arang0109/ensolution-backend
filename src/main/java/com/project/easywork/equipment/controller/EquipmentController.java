...
import com.project.easywork.equipment.service.impl.EquipmentFacade;
...
public class EquipmentController {
  ...
  public ResponseEntity<ApiResponse<EquipmentRegisterResD>> register(
    ...
    EquipmentDoc doc = equipmentFacade.register(dto);
  ...
  public ResponseEntity<ApiResponse<List<EquipmentDoc>>> getAllEquipmentList() {
    return ResponseEntity.ok().body(ApiResponse.success(equipmentFacade.getAllEquipments()));
  }
  ...
  public ResponseEntity<ApiResponse<List<EquipmentDoc>>> getParticleSamplerList() {
    return ResponseEntity.ok().body(ApiResponse.success(equipmentFacade.getList(EquipType.PARTICLE_SAMPLER)));
  }
  ...
  public ResponseEntity<ApiResponse<List<EquipmentDoc>>> getPitotTubeList() {
    return ResponseEntity.ok().body(ApiResponse.success(equipmentFacade.getList(EquipType.PITOT_TUBE)));
  }
  
  @Operation(summary = "노즐 목록 조회 API")
  @GetMapping("/nozzle")
  public ResponseEntity<ApiResponse<List<EquipmentDoc>>> getNozzleList() {
    return ResponseEntity.ok().body(ApiResponse.success(equipmentFacade.getList(EquipType.NOZZLE)));
  }
}