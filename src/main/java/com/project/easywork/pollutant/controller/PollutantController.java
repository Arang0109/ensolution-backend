...
public class PollutantController {
  ...
  @PostMapping()
  public ResponseEntity<ApiResponse<PollutantResponseDto>> register(
  ...
  @GetMapping()
  public ResponseEntity<ApiResponse<List<PollutantResponseDto>>> getList() {
  ...
  public ResponseEntity<ApiResponse<PollutantResponseDto>> get(@PathVariable Long pollutantId) {
  ...
  public ResponseEntity<ApiResponse<PollutantResponseDto>> update
      (
